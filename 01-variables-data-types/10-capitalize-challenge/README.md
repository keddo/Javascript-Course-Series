...
Take the variable `myString` and capitalize the first letter of the word using some of the methods that we talked about in the last session. Put the result in a variable called `myNewString`.
